      ...
      <div className="h-screen container mx-auto flex items-center justify-center text-white">
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] m-8 md:m-0 mt-20">
          ...
          <p className="text-center text-gray-400 mb-6">
            Signup To Buy the Courses
          </p>

          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="firstname" className="text-gray-400 p-2">
                First Name
              </label>
              <input
                className=" mt-1 w-full p-3 rounded-md bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                type="text"
